...
import lithuaniaFlag from "../img/countries/LITHUANIA.webp";

const Lithuania = () => {
  return (
    <div className="study-country">
      <Helmet>
        <title>NZ Education Consultants - Study in Lithuania</title>
        <meta
          name="description"
          content="NZ Education Consultants. Explore world-class education opportunities in Lithuania"
        />
      </Helmet>
      <div
        style={{
      ...
      <h1 className="study-country-title">STUDY IN LITHUANIA</h1>
      <p className="study-country-description">
        NZ Education Consultants are experts in guiding students through their
        educational journey in Lithuania. Our experienced team provides
      ...
      <section className="why-australia-section">
        <h2 className="section-title">Why Study in Lithuania?</h2>
        <div className="why-australia-grid">
          ...
          <div className="why-australia-card">
            ...
            <span>European Union Member</span>
          </div>
          <div className="why-australia-card">
      ...
      <section className="popular-courses-section">
        <h2 className="section-title">Popular Courses in Lithuania</h2>
