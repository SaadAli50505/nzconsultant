...
const Cyprus = () => {
  return (
    <div className="study-country">
      <Helmet>
        <title>NZ Education Consultants - Study in Cyprus</title>
        <meta
          name="description"
          content="NZ Education Consultants. Explore world-class education opportunities in Cyprus"
        />
      </Helmet>
      <div
        style={{
      ...
      <section className="why-australia-section">
        <h2 className="section-title">Why Study in Cyprus?</h2>
        <div className="why-australia-grid">
          ...
          <div className="why-australia-card">
            ...
            <span>Friendly & Safe Country</span>
          </div>
          <div className="why-australia-card">
            <FaMapMarkedAlt className="why-australia-icon" />
            <span>Beautiful Mediterranean Setting</span>
          </div>
        </div>
      </section>
      <section className="popular-courses-section">
        <h2 className="section-title">Popular Courses in Cyprus</h2>
