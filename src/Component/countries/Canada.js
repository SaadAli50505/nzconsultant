...
import canadaFlag from "../img/countries/canada.jpg";

const Canada = () => {
  return (
    <div className="study-country">
      <Helmet>
        <title>NZ Education Consultants - Study in Canada</title>
        <meta
          name="description"
          content="NZ Education Consultants. Explore world-class education opportunities in Canada"
        />
      </Helmet>
      <div
        style={{
      ...
      <h1 className="study-country-title">STUDY IN CANADA</h1>
      <p className="study-country-description">
        NZ Education Consultants are experts in guiding students through their
        educational journey in Canada. Our experienced team provides
      ...
      <section className="why-australia-section">
        <h2 className="section-title">Why Study in Canada?</h2>
      ...
      <section className="popular-courses-section">
        <h2 className="section-title">Popular Courses in Canada</h2>
        <ul className="popular-courses-list">
          ...
          <li>
            <FaUniversity className="course-icon" /> Environmental Studies
          </li>
        </ul>
      </section>
